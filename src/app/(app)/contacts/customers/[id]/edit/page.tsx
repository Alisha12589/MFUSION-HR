...
export default function EditCustomerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.ok) router.push('/contacts/customers')
  ...
  return (
    <div>
      <Header title="แก้ไขข้อมูลลูกค้า" />
      <div className="p-6 max-w-xl">
        <Link href="/contacts/customers" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-800 mb-4">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex justify-end gap-3 pt-2">
                <Link href="/contacts/customers"><Button type="button" variant="outline">ยกเลิก</Button></Link>
